            ...
            <div class="container border border-dark mw-75">
                ...
                <form class="text-center p-5" action="../action/verify.php" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="text" class="form-control p-5" name="username" placeholder="Email">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        <input id="password" type="password" class="form-control p-5" name="password" placeholder="Password">
                    </div>>
